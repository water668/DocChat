...
class PDFService:
    ...
    def __init__(self):
        ...
        self.storage_dir = Path('data/pdfs/uploads')
    ...
    async def upload_and_process(
        ...
        if db.query(PDFMetadata).filter(PDFMetadata.pdf_id == pdf_id).first() is not None:
            print("PDF with the same content already exists.")
